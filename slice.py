...
## Only direct data dependencies for registers beginning with %r are considered
## pop and push operation is not considered yet

# Used to match registers beginning with %r
